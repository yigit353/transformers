...
def get_final_text(pred_text, orig_text, do_lower_case, do_split_on_punc, verbose_logging=False):
    ...
    tokenizer = BasicTokenizer(do_lower_case=do_lower_case, do_split_on_punc=do_split_on_punc)
