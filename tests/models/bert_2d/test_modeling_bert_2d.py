...
""" Testing suite for the PyTorch Bert2D model. """
...
from transformers import Bert2dConfig
...
if is_torch_available():
    ...
    from transformers.models.bert_2d.modeling_bert_2d import (
...
class Bert2dModelTester:
    ...
    def create_and_check_for_causal_lm(
        ...
        model = Bert2dForCausalLM(config=config)
        model.to(torch_device)
        model.eval()
...
@require_torch
class Bert2dModelTest(ModelTesterMixin, unittest.TestCase):
    ...
    all_generative_model_classes = (Bert2dForCausalLM,) if is_torch_available() else ()
    ...
    def test_model_from_pretrained(self):
        for model_name in BERT_2D_PRETRAINED_MODEL_ARCHIVE_LIST[:1]:
...
class Bert2dModelIntegrationTest(unittest.TestCase):
    ...
    def test_inference_masked_lm(self):
        model = Bert2dForMaskedLM.from_pretrained("bert-2d-base-uncased")
