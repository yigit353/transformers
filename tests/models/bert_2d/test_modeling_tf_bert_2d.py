...
from transformers import is_tf_available, Bert2dConfig
...
class TFBert2dModelTester:
    ...
    def create_and_check_model(
        ...
        model = TFBert2dModel(config=config)
    ...
    def create_and_check_causal_lm_model(
        ...
        model = TFBert2dForCausalLM(config=config)
        inputs = {
            "input_ids": input_ids,
            "attention_mask": input_mask,
            "token_type_ids": token_type_ids,
    ...
    def create_and_check_for_masked_lm(
        ...
        model = TFBert2dForMaskedLM(config=config)
        inputs = {
            "input_ids": input_ids,
            "attention_mask": input_mask,
            "token_type_ids": token_type_ids,
    ...
    def create_and_check_for_sequence_classification(
        ...
        model = TFBert2dForSequenceClassification(config=config)
        inputs = {
            "input_ids": input_ids,
            "attention_mask": input_mask,
            "token_type_ids": token_type_ids,
    ...
    def create_and_check_for_multiple_choice(
        ...
        model = TFBert2dForMultipleChoice(config=config)
    ...
    def create_and_check_for_token_classification(
        ...
        config.num_labels = self.num_labels
        model = TFBert2dForTokenClassification(config=config)
        inputs = {
            "input_ids": input_ids,
            "attention_mask": input_mask,
            "token_type_ids": token_type_ids,
    ...
    def create_and_check_for_question_answering(
        ...
        model = TFBert2dForQuestionAnswering(config=config)
        inputs = {
            "input_ids": input_ids,
            "attention_mask": input_mask,
            "token_type_ids": token_type_ids,
...
@require_tf
class TFBert2dModelTest(TFModelTesterMixin, unittest.TestCase):
    ...
    def setUp(self):
        self.model_tester = TFBert2dModelTester(self)
    ...
    def test_model_from_pretrained(self):
        model = TFBert2dModel.from_pretrained("bert-2d-base-uncased")
        self.assertIsNotNone(model)

@require_tf
class TFBert2dModelIntegrationTest(unittest.TestCase):
    @slow
    def test_inference_masked_lm(self):
        model = TFBert2dForMaskedLM.from_pretrained("bert-2d-base-uncased")
